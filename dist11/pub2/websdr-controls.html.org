...
<div class="ctl">
  <div class="hideblind">
    ...
    <br>
    <div id="smeterpeak" style="width:100px;height:12px;background-color:#ff9000;position:absolute;">
      <div style="position:absolute;width:0px;height:0px;"></div>
    </div>
    <div id="smeterbar" style="width:100px;height:12px;background-color:#00ff00;position:absolute;">
      <div style="position:absolute;width:0px;height:0px;"></div>
    </div>
    <br>
